        ...
        <li class=" dropdown user-menu">
            ...
            <ul class="dropdown-menu pullDown">
                ...
                <li class="user-header">
                    <?php if (__user_info()->images): ?>
                        <img src="<?= base_url(__user_info()->images) ?>" class="img-circle uploaded_img" alt="User Image">
                    <?php else: ?>
                        <img src="<?= base_url('assets/backend/images/profile.png') ?>" class="img-circle uploaded_img" alt="User Image">
                    <?php endif; ?>
                    <p>
                        <?= __user_info()->name ?>
                        <small><?= __user_info()->email ?></small>
                        <!-- <small id="time"></small> -->
                    </p>
                </li>
                <!-- Menu Body -->
                ...
                <li class="user-footer">
                    <div class="pull-left">
                        <a href="<?= base_url('customer/dashboard/profile') ?>" class="btn btn-default btn-flat">Profile</a>
                    </div>

<div class="row">
  ...
  <div class="col-lg-3 col-md-4 col-sm-12">
    <div class="ticket-info-card total-category">
      <div class="ticket-cardBody ">
        <div class="leftContent">
        ...
        <div class="rightContent">
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-scroll-text-icon lucide-scroll-text">
              <path d="M15 12h-5" />
              <path d="M15 8h-5" />
